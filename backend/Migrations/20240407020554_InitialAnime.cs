        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Contry_name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contries_Animes_Anime_id",
                        column: x => x.Anime_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Genres_Animes_Anime_id",
                        column: x => x.Anime_id,
                        principalTable: "Animes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Statuses_Animes_Anime_id",
                        column: x => x.Anime_id,
                        principalTable: "Animes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contries_Anime_id",
                table: "Contries",
                column: "Anime_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Genres_Anime_id",
                table: "Genres",
                column: "Anime_id");

            migrationBuilder.CreateIndex(
                name: "IX_Statuses_Anime_id",
                table: "Statuses",
                column: "Anime_id",
                unique: true);
        }
